...
import { deleteMenu } from "../_lib/actions";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export function EditMenuButton({ id }: { id: number }) {
  return (
    <Tooltip>
      <TooltipTrigger asChild>
        <Link
          href={`/sys_menu/${id}/edit`}
...
export function DeleteMenuButton({ id }: { id: number }) {
  const [open, setOpen] = useState(false);
  const handleDelete = deleteMenu.bind(null, id);
