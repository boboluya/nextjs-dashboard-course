...
const links = [
  ...
  { name: "SystemUser", href: "/dashboard/sys_user", icon: ArrowDownCircleIcon },
  { name: "Menus", href: "/dashboard/sys_menu", icon: FolderIcon },
  { name: "Roles", href: "/dashboard/sys_role", icon: ShieldCheckIcon },
];
