...
import { deleteDictItem } from "../_lib/actions";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export function DeleteDictItemButton({ id }: { id: number }) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent showCloseButton={false} className="bg-white p-6">
        <DialogHeader>
          ...
          <DialogDescription>
            Are you sure you want to delete this dictionary item? This action cannot be undone.
          </DialogDescription>
        </DialogHeader>
