...
import { createSysMenu } from "../_lib/actions";
    ...
    <div className="m-6 bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
      <div className="bg-blue-500 p-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-white">Create Menu</h2>
            <p className="text-blue-100 text-sm">Fill in the form below to create a new menu</p>
          </div>
        </div>
      </div>
