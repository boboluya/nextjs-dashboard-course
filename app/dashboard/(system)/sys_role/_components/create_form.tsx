...
import { createSysRole } from "../_lib/actions";
      ...
      <div className="bg-blue-500 p-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-blue-100 text-sm">Fill in the form below to create a new role</p>
          </div>
        </div>
      </div>
        ...
        <div className="pt-6 border-t border-gray-100">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-3">
              ...
              >
                <Link href="/dashboard/sys_role">Cancel</Link>
              </Button>
              <Button
                type="submit"
