...
import { deleteDept } from "../_lib/actions";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export function CreateDeptButton() {
  return (
    <Link
...
export function EditDeptButton({ id }: { id: number }) {
  return (
    <Tooltip>
      <TooltipTrigger asChild>
        <Link
          href={`/dashboard/sys_dept/${id}/edit`}
...
export function DeleteDeptButton({ id }: { id: number }) {
