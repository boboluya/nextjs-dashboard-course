...
import { EditState } from "../_lib/actions";
import { updateSysDept } from "../_lib/actions";
...
export function EditForm({
  ...
  const [statusValue, setStatusValue] = useState(dept.status || "0");
  const [parentId, setParentId] = useState<number | null>(
    dept.parentId || null,
  );
  const initialState: EditState = { errors: {}, message: null };
  const updateSysDeptWithId = updateSysDept.bind(null, dept.id!);
