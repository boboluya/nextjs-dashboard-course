    ...
    <div className="m-6 bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
      <div className="bg-blue-500 p-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-blue-100 text-sm">Fill in the form below to create a new user account</p>
          </div>
        </div>
      </div>
      <form className="p-6 space-y-6" action={formAction}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Password Field */}
          <div className="space-y-2">
            <label htmlFor="password-field" className="flex items-center gap-2 text-sm font-semibold text-gray-700">
